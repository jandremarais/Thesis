...
There are 5 main question we attempt to answer in this chapter. They are:
...
2. How do the different loss functions act as a surrogate for the micro and macro F-score? (bce vs weighted bce vs rank loss vs retina loss)

3. Does multi-level predictions help to detect small objects?

4. Which extension works best to explicitly model label correlations? CG vs chaining vs SE-module

5. How does learnable label calibration modules compare to brute force search?
