...
+ Compare approaches in terms of the following metrics: macro and micro precision (P), recall (R) and $F_{1}$-score, in addition to the average precision (AP) (or AUC rather?). These are chose since they are the most popular metrics for multi-label image classification in the literature.
