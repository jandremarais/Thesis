...
The training is done in three parts. Training is done first by fine-tuning only the main net (second part I presume), which was pretrained on ImageNet. Then learning the attention map and confidence map simultaneously and then the convolution of the combination of the weighted attention map and confidence map. (This description will be much easier with notation).
