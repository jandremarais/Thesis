...
There are two ways of computing the gradient:

+ **numerical gradient**: slow, approximate, but simple.

+ **analytic gradient**: fast, exact, but more error-prone and requires calculus.
...
The obvious downfall of this approach is that we need to calculate the gradient in each direction/dimension. Neural networks have millions of parameters and therefore optimising them in this manner is clearly not feasible.
