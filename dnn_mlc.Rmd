...
Actually, does not look like a huge empirical improvement over the original CNN-RNN (compare on the common 3 ML image datasets). Again the compare with methods that utilise older CNN architectures.
