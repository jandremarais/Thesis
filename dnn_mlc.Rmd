...
Minimising various other loss functions has also been investigated (see Deep convolutional ranking for multi-label image annotation). Found that weighted approximate ranking loss worked best for CNNs.
