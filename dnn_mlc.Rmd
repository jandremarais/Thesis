...
The aim of the context gating unit after the classification layer is to downweight unlikely combinations such as 'Car' and 'Makeup'. It does this by reweighting the output probabilities.
...
+ [@Hu2016] for structured inference neural networks with label relations
