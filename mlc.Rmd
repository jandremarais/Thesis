...
This chapter serves as an overview of the multi-label classification (MLC) task. Since this framework is not that well known and contains some novelties compared to single label classification, it deserves some exploration. Here we are interested in the formal defintion of MLC, how MLC models are evaluated and some of the representative approaches to solve this problem.
